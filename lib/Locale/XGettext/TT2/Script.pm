...
package Locale::XGettext::TT2::Script;
...
sub __setKeywords {
    ...
    my %keywords = Locale::XGettext::TT2->defaultKeywords;
    while (my ($method, $argspec) = each %keywords) {
    	$keywords{$method} = Locale::XGettext::TT2::Keyword->new($method, @$argspec);
    }
    ...
    foreach my $option (@$options) {
        ...
        my $keyword = Locale::XGettext::TT2::Keyword->newFromString($option);
